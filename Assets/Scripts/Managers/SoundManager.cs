...
public class SoundManager : MonoBehaviour
{
    ...
    [Range(0,1)]
    [SerializeField] private float worldVolume;
    ...
    [Range(0,1)]
    [SerializeField] private float winGameVolume;
    ...
    [Range(0,1)]
    [SerializeField] private float beforeFightVolume;
    
    [SerializeField] private AudioClip winBattleSound;
    [Range(0,1)]
    [SerializeField] private float winBattleVolume;
    ...
    [Range(0,1)]
    [SerializeField] private float addHealthVolume;
    ...
    [Range(0,1)]
    [SerializeField] private float joinedTheTeamVolume;
    
    [SerializeField] private AudioClip goodSequenceClickSound;
    [Range(0,1)]
    [SerializeField] private float goodSequenceClickVolume;
    ...
    public void PlayThemeByScene()
    {
        ...
        switch (sceneName)
        {
            ...
            case MySceneManager.k_FIGHT:
                int rand = Random.Range(0, battleMusic.Length);
